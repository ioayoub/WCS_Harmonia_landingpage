    ...
    <>
      <main className="container">
        ...
        <nav className="navbar">
          <ul>
            <li>
              <a href="https://documentation-harmonia.vercel.app/" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <a href="https://github.com/WildCodeSchool/js-template-fullstack" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50">
                  <path
        ...
        <section className="text-box">
          ...
          <a href="https://documentation-harmonia.vercel.app/" className="btn btn-white btn-animated"
             target="_blank" rel="noopener noreferrer">Documentation</a>
        </section>

        <footer>
          Développé par la <a href="https://www.wildcodeschool.com/" className="wcs" target="_blank" rel="noopener noreferer">Wild Code School</a>
        </footer>
      </main>
    </>
  )
