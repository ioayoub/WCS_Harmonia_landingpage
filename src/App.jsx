      ...
      <main className="container">
        ...
        <div className="text-box">
          <h1 className="heading-primary">
            <span className="heading-primary-main">Harmonia</span>
            <span className="heading-primary-sub">Votre framework JavaScript</span>
          </h1>
          <a href="https://documentation-harmonia.vercel.app/" className="btn btn-white btn-animated">Documentation</a>
        </div>
        <footer>
          Développé par la <a href="https://www.wildcodeschool.com/" className="wcs">Wild Code School</a>
        </footer>
      </main>
    </>
  )
